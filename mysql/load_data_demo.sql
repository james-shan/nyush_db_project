...
--
-- Dumping data for table `booking_agent_work_for`
--

INSERT INTO `booking_agent_work_for` (`email`, `airline_name`) VALUES 
('Booking@agent.com', 'Jet Blue'),
('Professional@booking.com', 'Jet Blue');
...
('Jet Blue', 139, 'SFO', '2018-12-20 23:50:00', 'JFK', '2018-12-21 08:50:00', '200', 'Upcoming', 1),
('Jet Blue', 296, 'O\'Hare', '2019-01-01 12:00:00', 'SFO', '2019-01-01 14:00:00', '420', 'Upcoming', 1),
('Jet Blue', 307, 'La Guardia', '2018-12-19 22:00:00', 'SFO', '2018-12-20 02:00:00', '600', 'Upcoming', 1),
('Jet Blue', 455, 'JFK', '2018-12-25 05:00:00', 'Louisville SDF', '2018-12-25 07:00:00', '97', 'Upcoming', 3),
('Jet Blue', 915, 'O\'Hare', '2018-09-01 00:00:00', 'SFO', '2018-09-01 04:00:00', '500', 'Delayed', 2);
...
(1, 'Customer@nyu.edu', NULL, '2022-4-01'),
(2, 'Customer@nyu.edu', 1, '2022-4-17'),
(3, 'one@nyu.edu', 2, '2022-4-10'),
(4, 'two@nyu.edu', 2, '2022-4-11'),
(5, 'Customer@nyu.edu', 1, '2022-4-12'),
(6, 'one@nyu.edu', null, '2022-04-19'),
(7, 'two@nyu.edu', null, '2022-04-23'),
(8, 'one@nyu.edu', 1, '2022-4-15'),
(9, 'Customer@nyu.edu', 1, '2022-04-19');
